...
bump:major - Upgrades the package's major version and publishes to npm.
bump:minor - Upgrades the package's minor version and publishes to npm.
bump:patch - Upgrades the package's patch version and publishes to npm.
`);
  }
}
